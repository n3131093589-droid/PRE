...
id_data_dict = pkl.load(open('/cmy_project/code/hdn-main-sub_ex_change-drugbank/PRE-substructure-extraction-change/drugbank_test/DrugBank/id_data_dict_dsn_full_connect.pkl', 'rb'))

df_drugs_smiles = pd.read_csv('/cmy_project/code/hdn-main-sub_ex_change-drugbank/PRE-substructure-extraction-change/drugbank_test/DrugBank/drug_smiles.csv')
...
df_all_pos_ddi = pd.read_csv('/cmy_project/code/hdn-main-sub_ex_change-drugbank/PRE-substructure-extraction-change/drugbank_test/DrugBank/ddis.csv')
