...
def build_parser():
    ...
    parser.add_argument('--pkl_name', type=str, default='/cmy_project/code/hdn-main-sub_ex_change-drugbank/PRE-substructure-extraction-change/drugbank_test/pkl/db-0402_1033-fold0-ab2-ng1.pkl')
    return parser
