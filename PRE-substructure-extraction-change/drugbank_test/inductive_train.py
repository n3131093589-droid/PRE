...
def main():
    ...
    df_ddi_train = pd.concat([
        pd.read_csv(f'/cmy_project/code/hdn-main-sub_ex_change-drugbank/PRE-substructure-extraction-change/drugbank_test/DrugBank/cold_start/fold{args.fold}/train.csv'),
        pd.read_csv(f'/cmy_project/code/hdn-main-sub_ex_change-drugbank/PRE-substructure-extraction-change/drugbank_test/DrugBank/cold_start/fold{args.fold}/val.csv')
    ], axis=0)
    df_ddi_s1 = pd.read_csv(f'/cmy_project/code/hdn-main-sub_ex_change-drugbank/PRE-substructure-extraction-change/drugbank_test/DrugBank/cold_start/fold{args.fold}/s1.csv')
    df_ddi_s2 = pd.read_csv(f'/cmy_project/code/hdn-main-sub_ex_change-drugbank/PRE-substructure-extraction-change/drugbank_test/DrugBank/cold_start/fold{args.fold}/s2.csv')
