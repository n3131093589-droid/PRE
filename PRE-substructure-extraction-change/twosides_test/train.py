...
def main():
    ...
    df_ddi_test = pd.read_csv(f'/cmy_project/code/hdn-main-sub_ex_change-drugbank/PRE-substructure-extraction-change/twosides_test/twosides/fold{args.fold}/test.csv')
